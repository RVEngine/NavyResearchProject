...
{
  friend class APIHelper<Gears, APIManager_v6>;

public:
  START_APIS(Gears)
  REGISTER_API(LifeformAspectAPI, 3, Single)
  REGISTER_API(TransformationAspectAPI, 5, Single)
  REGISTER_API(EnvironmentAPI, 3, Single)
  REGISTER_API(SimulationAspectAPI, 1, Single)
  REGISTER_API(WorldAPI, 6, Single)
  REGISTER_API(LogAPI, 1, Instance)
  REGISTER_API(IMGuiAPI, 1, Single)
//  REGISTER_API(DebugUIListenerAPI, 2, Single)
  REGISTER_API(CameraAspectAPI, 3, Single)
  REGISTER_API(DebugUIAPI, 2, Single)
  REGISTER_API(MissionAPI, 4, Single)
  REGISTER_API(ScriptAPI, 3, Single)
  REGISTER_API(DamageAspectAPI, 4, Single)
  REGISTER_API(WeaponSystemAspectAPI, 6, Single)
...
//  REGISTER_MY_API(IMGuiAPI, 1)
//  REGISTER_MY_API(MissionAPI, 4)
